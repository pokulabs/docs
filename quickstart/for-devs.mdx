...
Check [supported countries](/reference/supported-countries) for WhatsApp availability.
...
<CardGroup cols={2}>
  <Card title="Install the Poku Skill" icon="puzzle-piece" href="/poku-skill/installation">
    Give your coding agent (Cursor, Claude Code, and more) the ability to call and message — no manual API calls needed.
  </Card>
