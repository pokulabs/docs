...
When you ask your Openclaw agent to send a text, it drafts the message, confirms with you before sending, and reports back on delivery. You can also ask your agent to text multiple people at once. The agent will send each message individually and confirm delivery for each recipient.
