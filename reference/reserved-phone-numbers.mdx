...
description: "Your OpenClaw agent can reserve a phone number to make calls and send text messages."
---
...
You can reserve a number directly via the API, or by asking your Openclaw agent to do it for you if it has the Poku Skill installed.
...
If you have the Poku Skill installed, you can also ask your OpenClaw agent in plain language, for example:
