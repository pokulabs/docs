...
Once the call ends, Poku sends a summary of the call to your OpenClaw agent via webhook. You'll receive a notification in real-time through whichever channel you've configured (e.g. Telegram, Slack).
