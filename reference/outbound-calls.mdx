...
Pass the `language` parameter to optimize speech recognition for a specific dialect. For example, `fr-FR` for French. See the full list of [supported languages](/api-reference/calls/place-outbound-call#body-language).
