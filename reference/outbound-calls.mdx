...
Pass the `language` parameter to specify the language for the call. For example, `fr-FR` for French. See the full list of [supported languages](/api-reference/calls/place-outbound-call#body-language).
