...
description: "Install and configure the Poku skill for any agent that supports the Agent Skills format, including Openclaw, Cursor, Claude Code, OpenCode, OpenAI Codex, and Pi."
