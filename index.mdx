...
<Steps>
  ...
  <Step title="Add your API key">
   ...
   {
     "env": {
       "POKU_API_KEY": "$POKU_API_KEY"
     }
   }
   ```
  </Step>
  <Step title="Reload OpenClaw">
    Run `openclaw gateway restart` so the new env var is available to the skill.
  </Step>
...
**5. Follow steps from "Configuration" section above to add your Poku API key**
